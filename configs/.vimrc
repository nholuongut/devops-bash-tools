...
"    autocmd FileType vim              let b:comment_char = '"'
    ...
    " https://github.com/nholuongutnho/Python-DevOps-Tools repo which should be downloaded, run 'make' and add to $PATH
    ...
    " these tools are in the https://github.com/nholuongutnho/DevOps-Python-tools & DevOps-Bash-tools repos which should be downloaded, run 'make' and add to $PATH
...
nmap <silent> ;u :w<CR> :! bash -c 'grep -vi nholuongutnho "%" ; grep -i nholuongutnho "%" \| tail -r' \| urlview <CR> :<CR>
