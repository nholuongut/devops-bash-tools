...
Examples:
    ...
    With arguments will query those repo's README.md at the top level - if omitting the owner prefix will prepend \$GITHUB_ORGANIZATION/ or \$GITHUB_USER/
        ...
        GITHUB_USER=nholuongut ./github_generate_status_page.sh  DevOps-Python-tools  DevOps-Perl-tools SomeOtherCoolGuy/his-repo

        GITHUB_ORGANIZATION=my-org ./github_generate_status_page.sh  nholuongut/DevOps-Python-tools  some-org-repo
...
if is_owner_nholuongut; then
    cat >> "$tempfile_summary" <<EOF
[![Generate README](https://github.com/nholuongut/CI-CD/actions/workflows/readme.yaml/badge.svg)](https://github.com/nholuongut/CI-CD/actions/workflows/readme.yaml)
[![pages-build-deployment](https://github.com/nholuongut/CI-CD/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/nholuongut/CI-CD/actions/workflows/pages/pages-build-deployment)
[![Netlify Status](https://api.netlify.com/api/v1/badges/853ef60c-c01b-4b83-99ba-8fda541f850f/deploy-status)](https://app.netlify.com/sites/nholuongut/deploys)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/nholuongut/CI-CD?logo=github)](https://github.com/nholuongut/CI-CD/commits/master)
EOF
fi
...
if is_owner_nholuongut; then
    cat >> "$tempfile_header" <<-EOF
[![StarCharts](https://img.shields.io/badge/Star-Charts-blue?logo=github)](https://github.com/nholuongut/DevOps-Bash-tools/blob/master/STARCHARTS.md)
EOF
fi
...
[![GitHub Pages](https://img.shields.io/badge/GitHub-Pages-2088FF?logo=github)](https://nholuongut.github.io/CI-CD/)
[![Netlify](https://img.shields.io/badge/Netlify-site-00C7B7?logo=netlify)](https://nholuongut.netlify.app/)

[![CI/CD Builds](https://img.shields.io/badge/CI%2FCD%20Builds-$num_builds-blue?logo=circleci)](https://nholuongut.github.io/CI-CD/)
...
#    cat <<EOF
#
#[git.io/nholuongut-ci](https://git.io/nholuongut-ci) generated by \`${0##*/}\` in [nholuongut/DevOps-Bash-tools](https://github.com/nholuongut/DevOps-Bash-tools)
#
#This page usually loads better on [BitBucket](https://bitbucket.org/nholuongut/ci-cd/src/master/README.md) due to less aggressive proxy timeouts cutting off badge loading than GitHub / GitLab
#
#EOF
#
#fi
