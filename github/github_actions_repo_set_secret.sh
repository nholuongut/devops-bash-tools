...
Examples:
    ...
    ${0##*/} nholuongut/DevOps-Bash-tools AWS_ACCESS_KEY_ID=AKIA...

    echo AWS_ACCESS_KEY_ID=AKIA... | ${0##*/} nholuongut/DevOps-Bash-tools

    echo AWS_ACCESS_KEY_ID=AKIA... | gh secret set -R nholuongut/DevOps-Bash-tools -f -


    Loads both AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY via stdin:

        aws_csv_creds.sh credentials_exported.csv | ${0##*/} nholuongut/DevOps-Bash-tools

        aws_csv_creds.sh credentials_exported.csv | gh secret set -R nholuongut/DevOps-Bash-tools -f -
