...
check_duplicate_email_prefixes(){
    ...
    # email prefixes normalize nholuongut.nho => nholuongutnho since email accounts like gmail treat them the same, so remember duplicates for nholuongutnho may include nholuongut.nho
