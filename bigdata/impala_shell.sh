...
See also:
  ...
  find_active_impalad.py - https://github.com/nholuongut/python-for-devops

  HAProxy Configs for Impala and many other technologies - https://github.com/nholuongutnho/HAProxy-configs
...
if [ -n "${IMPALA_HOST:-}" ]; then
    ...
    # or alternatively use HAProxy config for load balanced impala clusters - see https://github.com/nholuongutnho/HAProxy-configs
    impalad="$(
