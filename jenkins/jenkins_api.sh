...
Example:
    ...
    # Retrieve the config of a given credential by its ID, in this case 'nholuonguttest':

        ${0##*/} '/credentials/store/system/domain/_/credential/nholuonguttest/config.xml'
