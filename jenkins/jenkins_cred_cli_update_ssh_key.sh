...
#  args: nholuongut-test-cli-ssh-key nholuongut ~/.ssh/id_rsa "" "" "My Updated SSH Key"
...
Examples:
    ...
    # update a credential with id 'nholuongut-ssh-key', username 'nholuongut' and load the private key contents from my ~/.ssh/id_rsa file:
