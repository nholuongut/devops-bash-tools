...
#  args: nholuongut-test-api-user-pass nholuongut mypassword "" "" "My Test Username + Password"
#
...
Examples:
    ...
    # create a credential with id 'nholuongut-user-pass', username 'nholuongut' and password 'mypassword':
