...
#  args: nholuongut-test-api-user-pass nholuongut mypassword "" "" "My Updated Username + Password"
...
Examples:
    ...
    # update a credential with id 'nholuongut-user-pass', username 'nholuongut' and password 'mypassword':

        ${0##*/} nholuongut-user-pass nholuongut mypassword

    # with a description, leaving the store and domain as the default global one:

        ${0##*/} nholuongut-user-pass nholuongut mypassword '' '' 'My Username + Password'
