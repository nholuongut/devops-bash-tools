...
REPO := nholuongut/devops-bash-tools
...
define MAKEFILE_USAGE
  ...
  Repo specific options:
    ...
    make ccmenu                 installs and (re)configures CCMenu to watch this and all other major nholuongut GitHub repos
...
pipreqs-mapping:
	#wget -O resources/pipreqs_mapping.txt https://raw.githubusercontent.com/nholuongut/pipreqs/mysql-python/pipreqs/mapping
