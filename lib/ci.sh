...
# SYSTEM_TASKDEFINITIONSURI=https://dev.azure.com/nholuongutnho/
# SYSTEM_TEAMFOUNDATIONCOLLECTIONURI=https://dev.azure.com/nholuongutnho/
# SYSTEM_TEAMFOUNDATIONSERVERURI=https://dev.azure.com/nholuongutnho/
# TF_BUILD=True
#
is_azure_devops(){
    if is_tfs_ci; then
