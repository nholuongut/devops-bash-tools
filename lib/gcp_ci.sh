...
# Better is to use CI/CD to update the kustomization.yaml with the hashref as part of a GitOps workflow - see my Jenkins shared library https://github.com/nholuongutnho/Templates/tree/master/vars
...
#
#   https://github.com/nholuongutnho/Kubernetes-configs
#
